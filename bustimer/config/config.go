...
var MultiTimetableQuery string = "京都駅前,西ノ京円町《ＪＲ円町駅》,西大路四条《阪急･嵐電西院駅》,四条大宮,三条京阪前,二条駅前"
var MultiTImetableBusstopList [6]string = [6]string{"京都駅前", "西ノ京円町《ＪＲ円町駅》", "西大路四条《阪急･嵐電西院駅》", "四条大宮", "三条京阪前", "二条駅前"}
